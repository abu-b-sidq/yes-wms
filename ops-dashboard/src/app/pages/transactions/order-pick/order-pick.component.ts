...
@Component({
        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()">
          ...
          <div class="submit-area">
            <button mat-flat-button color="primary" type="submit" class="submit-btn" [disabled]="submitting()">
              ...
              {{ submitting() ? 'Executing...' : 'Execute Order Pick' }}
            </button>
          </div>
        </form>
      </div>
  ...
  styles: [`
    ...
    .pick-line { background: #f8fafc; border-radius: 10px; padding: 12px; margin-bottom: 12px; display: flex; flex-direction: column; gap: 4px; }
    .line-header { display: flex; align-items: center; justify-content: space-between; margin-bottom: 4px; }
    .line-num { font-size: 13px; font-weight: 600; color: #dc2626; }
