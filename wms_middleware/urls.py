...
from wms_middleware.admin_views import management_commands_stream_view, management_commands_view
...
urlpatterns = [
    ...
    path(
        "admin/management-commands/stream/",
        admin.site.admin_view(management_commands_stream_view),
        name="admin_management_commands_stream",
    ),
